...
export default function App() {
  ...
  const getShiftCellStyles = (shift: ShiftType, isToday: boolean) => {
    ...
    if (isToday) {
      ...
      styles.bg = `${styles.bg} ring-2 ring-blue-800 shadow-md shadow-blue-800/45 scale-[1.03] z-5 relative`;
      
      // ESTADO ANTERIOR (Original):
      // styles.text = styles.text.replace('font-medium', '') + ' font-extrabold italic text-base sm:text-lg';
      
      // ESTADO CELESTE/AZUL (Intermedio - blue-500/600):
      // styles.text = styles.text.replace(/text-[a-z0-9-#\[\]\/]+/g, '') + ' text-blue-500 font-extrabold italic text-base sm:text-lg';
      
      // NUEVO ESTADO (Azul Más Oscuro - blue-800) con grosor extra:
      styles.text = styles.text.replace(/text-[a-z0-9-#\[\]\/]+/g, '') + ' text-blue-800 font-black italic text-base sm:text-lg';
    }
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-gray-100 font-sans flex flex-col justify-between selection:bg-red-500 selection:text-white" id="main-view-container">
      ...
      <div className="w-full max-w-lg md:max-w-4xl lg:max-w-5xl mx-auto flex-1 flex flex-col justify-between bg-slate-900 border-x border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <header className="py-2.5 px-4 border-b border-slate-800 bg-slate-900/90 backdrop-blur-md sticky top-0 z-10 flex items-center justify-center relative">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-[13px] text-gray-400 font-mono uppercase tracking-widest leading-none mt-1">
                Versión 3.45 WEB
              </p>
              <p className="text-[13px] text-gray-400 font-bold italic mt-1 leading-none">
                by Ale Corvi © 2026
              </p>
            </div>
          </button>
        ...
        {/* CONTAINER CONTENT */}
        <main className="px-4 pt-2 pb-4 flex-1 flex flex-col md:flex md:flex-row md:justify-center md:items-stretch md:gap-3.5 md:space-y-0 space-y-3 items-stretch">
          
          {/* LEFT SIDE: SELECTORS & CONFIG (on PC/Tablet) */}
          <div className="w-full md:w-[180px] shrink-0 flex flex-col gap-4 justify-start">
            
            {/* SECTION A: DROP DOWN CONTROLS */}
            <div className="bg-slate-950/80 p-4 rounded-2xl border border-slate-800/80 space-y-4 shadow-inner md:h-full flex flex-col justify-center" id="picker-controls">
              ...
              <div className="grid grid-cols-3 md:grid-cols-1 gap-3 md:gap-4 items-stretch">
                ...
                <div className="flex flex-col gap-1">
                  <span className="hidden md:block text-[11px] font-bold text-slate-400 font-mono uppercase tracking-wider md:text-center">
                    Mes de Consulta
                  </span>
                  <div className="relative">
                    <select
                      ...
                      className={`w-full p-2.5 rounded-xl border border-slate-800 bg-slate-900 text-sm font-bold tracking-wide focus:outline-hidden focus:border-red-500 focus:ring-1 focus:ring-red-500 cursor-pointer appearance-none md:text-center ${
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full p-2.5 rounded-xl border border-slate-800 bg-slate-900 text-white text-sm font-bold tracking-wider focus:outline-hidden focus:border-red-500 focus:ring-1 focus:ring-red-500 cursor-pointer appearance-none md:text-center"
          ...
          <div className="w-full md:w-[450px] shrink-0 flex flex-col justify-start">
